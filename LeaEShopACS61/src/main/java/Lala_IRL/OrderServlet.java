	...
	protected void doGet(HttpServletRequest request,
		...
		try {
			...
			connect = DriverManager.getConnection(
					"jdbc:mysql://localhost/Lala_IRL", "root", "");
			...
			out.println("<!DOCTYPE html><html><head><link rel=\"icon\" href=\"img_index.jpg\" type=\"image/jpg\" /><link rel='stylesheet' href='css/style1.css'/><head><body>");
